...
When('I open the page settings drawer', () => {
    editorFeatures.designSideBar().click()
})

Then('I should see the color settings', () => {
    editorFeatures.drawerBody().should('exist').and('contain.text', 'Brand Color')
})

When('I change the brand color', () => {
    editorFeatures.brandColorInput().click().clear().type(changedBrandColor)
})

Then('I should see changes on the builder', () => {
    editorFeatures.headerBody().should('have.css', 'background-color').and('be.colored', changedBrandColor)
})

When('I close the drawer', () => {
    editorFeatures.settingCloseIcon().click()
})

Then('I should see the changes has been reverted', () => {
    editorFeatures.headerBody().should('have.css', 'background-color').and('be.colored', firstBrandColor)
})

When('I open the drawer and make the changes again in both Brand and Accent color', () => {
    editorFeatures.designSideBar().click()
    editorFeatures.brandColorInput().click().clear().type(changedBrandColor)
    editorFeatures.accentColorInput().click().clear().type(changedAccentColor)
})
...
And('I should see both Brand and Accent Color being changed in the page', () => {
    ...
    editorFeatures.designSideBar().click()
    editorFeatures.brandColorInput().click().clear().type(firstBrandColor)
    editorFeatures.accentColorInput().click().clear().type(firstAccentColor)
    editorFeatures.settingSaveButton().click()
})
