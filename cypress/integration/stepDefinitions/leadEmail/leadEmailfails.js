...
When(`I fill every contents of form leaving name field empty on Footer Contact Form`, (datatable) => {
datatable.hashes().forEach((element)=>{
  cy.get('.footer [name=phone].form-control').scrollIntoView({force: true}).type(element.phone, {force: true})
...
When(`I fill every contents of form leaving name field empty on Interior Page`, (datatable) => {
    datatable.hashes().forEach((element)=>{
    cy.get('.footer [name=phone].form-control').scrollIntoView({force: true}).type(element.phone, {force: true})
    cy.get('.footer [name=email].form-control').type(element.email, {force: true})
    cy.get('.footer [name=inquiry].form-control').type(element.case, {force: true})
...
When(`I fill every contents of form leaving name field empty on PPC landing Header form`, (datatable) => {
datatable.hashes().forEach((element)=>{
